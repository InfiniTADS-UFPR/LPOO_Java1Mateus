...
public class SistemaAcademico {
    public static void main(String[] args){
        ...
        Professor profe1 = new Professor("Rafael",50,1);
        Disciplina disciplina = new Disciplina("LPOO",profe1);
        profe1.cadastraDisciplina(disciplina);
        ...
        while(true){
            ...
            switch (opcao){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println(matricularAlunoEmDisciplina(vetor,disciplina));
                    break;
                case 5:
    ...
    public static String matricularAlunoEmDisciplina(Aluno[] vetor, Disciplina disciplina){
        int i=0;
        Scanner scanner = new Scanner(System.in);
